        ...
        <header className="flex h-16 shrink-0 items-center gap-2 border-b border-muted/50 bg-background/80 px-4 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12">
          ...
          <div className="ml-auto flex items-center gap-2">
            <Button asChild variant="outline" size="sm" className="gap-2">
              <a
                href="https://github.com/baole405/fullstack-assignment"
                target="_blank"
                rel="noreferrer"
              ...
              >
                ...
                >
                  <path
                    fill="currentColor"
                    d="M12 0C5.37 0 0 5.37 0 12c0 5.3 3.438 9.8 8.205 11.387.6.113.82-.263.82-.582 0-.288-.01-1.05-.016-2.06-3.338.726-4.042-1.61-4.042-1.61-.546-1.387-1.333-1.757-1.333-1.757-1.09-.745.083-.73.083-.73 1.205.086 1.84 1.237 1.84 1.237 1.07 1.835 2.807 1.305 3.492.998.108-.776.42-1.305.763-1.605-2.665-.303-5.466-1.335-5.466-5.93 0-1.31.468-2.38 1.236-3.22-.124-.303-.536-1.523.117-3.176 0 0 1.008-.322 3.3 1.23.957-.266 1.98-.399 3-.405 1.02.006 2.043.14 3 .405 2.29-1.552 3.296-1.23 3.296-1.23.655 1.653.243 2.873.12 3.176.77.84 1.235 1.91 1.235 3.22 0 4.61-2.804 5.625-5.476 5.92.43.37.814 1.096.814 2.21 0 1.596-.014 2.883-.014 3.276 0 .322.216.698.824.58C20.565 21.797 24 17.297 24 12c0-6.63-5.37-12-12-12z"
                  />
                </svg>
                Repo
              </a>
